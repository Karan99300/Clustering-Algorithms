...
def main():
    ...
    for i, file in enumerate(csv_files):
        ...
        best_metrics = dbscan_based_tuning(df_normalized.values, k_values[i])
    ...
    results_df.to_csv("/mnt/private/Clustering-Algorithms/hyperparameter_tuning/dbscan_tuning_results.csv", index=False)
